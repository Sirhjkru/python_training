...
def test_add_contact(app):
    ...
    app.add_phone_number(CompanyDetails(mobile_num='786512', work_num='222', fax_num='125423'))
    app.add_email(CompanyDetails(email_1='easdq@mail.ru', email_2='testtest@yandex.ru', email_3='asdasdqwe@google.com'))
    app.add_homepage(CompanyDetails(homepage='vk.com'))
    app.add_date_birth(CompanyDetails(day='12', month='July', year='1990'))
...
def test_add_contact2(app):
    ...
    app.add_phone_number(CompanyDetails(mobile_num='7812312', work_num='22112', fax_num='1254124423'))
    app.add_email(CompanyDetails(email_1='e234234asdq@mail.ru', email_2='test123123test@yandex.ru', email_3='asda34234sdqwe@google.com'))
    app.add_homepage(CompanyDetails(homepage='v11312k.com'))
    app.add_date_birth(CompanyDetails(day='13', month='July', year='1994'))
